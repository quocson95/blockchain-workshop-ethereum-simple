...
import * as SDQNFT from '../../../build/contracts/SondqNFT.json';
import { SondqNFT } from '../../types/SondqNFT';
...
export class SondqNFTWrapper {
    ...
    constructor(web3: Web3) {
        this.web3 = web3;
        this.contract = new web3.eth.Contract(SDQNFT.abi as any) as any;
    }
